...
export const PRODUCTS: Product[] = [
  ...
  {
    id: "wt-armani",
    title: "Emporio Armani AR2448 Men's Chronograph Watch",
    description: "Classic styling meets pure sophistication. Our Emporio Armani classic chronograph watch in silver features an elegant dark blue dial with high-density silver batons, multi-link stainless steel bracelet, mineral crystal glass face and three-eye mechanical timing. Perfect for premium events.",
    price: 15990,
    originalPrice: 24500,
    discountTag: "35% OFF",
    ...
    isNewArrival: true,
    inStock: true,
    colors: ["Classic Silver Steel"],
    sizes: ["Standard"]
  },
  {
    id: "wt-naviforce",
    title: "Naviforce NF9163 Men's Watch",
    description: "Bold gold design with multiple functional subdials. Perfect combination of sport style and premium business presence.",
    price: 2450,
    originalPrice: 3500,
    discountTag: "30% OFF",
  ...
  {
    id: "wt-casio",
    title: "Casio MTP-1375 Men's Watch",
    description: "Authentic Casio Multi-Hand watch with steel chain bracelet and dynamic blue dial indices.",
    price: 4890,
    originalPrice: 6700,
    discountTag: "27% OFF",
  ...
  {
    id: "wt-fossil",
    title: "Fossil FS4835 Men's Watch",
    description: "Sleek matte black Fossil design featuring durable leather overlay strap and midnight casing.",
    price: 11990,
    originalPrice: 17500,
    discountTag: "31% OFF",
  ...
  {
    id: "wt-citizen",
    title: "Citizen BI5100 Men's Watch",
    description: "Classic dial configuration with polished stainless steel outer casing and dark aesthetic lines.",
    price: 8250,
    originalPrice: 11500,
    discountTag: "28% OFF",
